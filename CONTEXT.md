...
- Lint/TS: `ignoreBuildErrors: true`; lint con ESLint 9 flat config (`eslint.config.mjs`, presets js/ts recomendados) vía `eslint . --max-warnings=0` (ignorando `.next/**`, `android/**` y `out/**`); script `next typegen` disponible.
